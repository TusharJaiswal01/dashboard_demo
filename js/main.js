...
const easeChart = () => {
  ...
  const easeProjectColo$ = ["#dddde2", "#add4b8", "#bdbfff", "#c098a2"]
    ...
    datasets: [
      {
        ...
        data: [125, 200, 576],
        borderWidth: 1,
        backgroundColor: easeProjectColo$[0],
        borderColor: easeProjectColo$[0],
      },
      {
        label: "Completed",
        data: [120, 185, 243],
        borderWidth: 1,
        backgroundColor: easeProjectColo$[1],
        borderColor: easeProjectColo$[1],
      },
      {
        label: "In progress",
        data: [5, 10, 102],
        borderWidth: 1,
        backgroundColor: easeProjectColo$[2],
        borderColor: easeProjectColo$[2],
      },
      {
        label: "Delayed / canceled",
        data: [0, 5, 231],
        borderWidth: 1,
        backgroundColor: easeProjectColo$[3],
        borderColor: easeProjectColo$[3],
      },
    ]
  }
  ...
  const easeProjectEarnColo$ = ["#bdbfff", "#c098a2", "#add4b8", "#fdc4a1"]
    ...
    datasets: [
      {
        ...
        borderWidth: 1,
        backgroundColor: easeProjectEarnColo$,
        borderColor: easeProjectEarnColo$,
      }
    ]
  }
  ...
  const easeRevenueColo$ = ["rgba(221, 221, 226, 0.25)", "rgba(192, 152, 162, 0.35)", "rgba(173, 212, 184, 0.45)", "rgba(253, 196, 161, 0.55)"]
    ...
    datasets: [
      {
        ...
        borderWidth: 1,
        backgroundColor: easeRevenueColo$,
        borderColor: easeRevenueColo$,
